...
- Any separately authorized Task 1 resumption may begin only after the exact two-document round-4 planning amendment is normally committed, pushed, fetched, read back, and the preserved 147-file live-state fingerprint plus empty index are re-proven unchanged.
